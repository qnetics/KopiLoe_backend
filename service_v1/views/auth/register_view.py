...
from service_v1.controllers.universal_controllers.register_controller import register_controller
...
def register_view (request) :
    ...
    if request.method == "POST" : 
        ...
        http_status_code, message_response, data_response = register_controller(
