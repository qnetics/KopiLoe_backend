...
from service_v1.controllers.user_controllers.update_cart_controller import update_cart_controller
...
def update_cart_view (request) :
    ...
    if request.method == "PUT" :
        ...
        http_status_code, message_response, data_response = update_cart_controller(
