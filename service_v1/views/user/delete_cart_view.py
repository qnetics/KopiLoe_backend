...
from service_v1.controllers.user_controllers.delete_cart_controller import delete_cart_controller
...
def delete_cart_view (request) :
    ...
    if request.method == "DELETE" :
        ...
        http_status_code, message_response, data_response = delete_cart_controller(
