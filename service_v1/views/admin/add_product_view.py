...
from service_v1.controllers.admin_controllers.add_product_controller import add_product_controller
...
def add_product_view (request) :
    ...
    if request.method == "POST" :
        ...
        http_status_code, message_response, data_response = add_product_controller(
